...
using InputType = CommunityToolkit.ReportEditor.Model.Models.InputType;
using RadioButton = System.Windows.Controls.RadioButton;
using TextBox = System.Windows.Controls.TextBox;

namespace MasterNeverDown.ReportStudio.Viewer.ViewModels;

public class ParameterBuildFactory
{
    private static readonly Lazy<ParameterBuildFactory> Instance = new(() => new ParameterBuildFactory(DataSourceContext.Factory));

    private readonly DataSourceContext _dataSourceContext;

    public static ParameterBuildFactory Factory => Instance.Value;

    private ParameterBuildFactory(DataSourceContext dataSourceContext)
    {
