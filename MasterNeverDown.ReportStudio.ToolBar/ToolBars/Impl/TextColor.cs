...
public class TextColor(ReoGridControl grid) :ToolbarBase(grid)
{
    public override void Execute(params object[] param)
    {
        try
        {
            grid.CurrentWorksheet.Ranges[CurrentSelectionRange].Style.TextColor = unvell.ReoGrid.Graphics.SolidColor.Red;
        }
