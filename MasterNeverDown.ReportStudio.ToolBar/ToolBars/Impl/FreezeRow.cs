...
public class FreezeRow(ReoGridControl grid) : ToolbarBase(grid)
{
    public override void Execute(params object[] param)
    {
        try
        {
            ...
            var rowIndex = CurrentSelectionRange.StartPos.Row;
            sheet.FreezeToCell(CurrentSelectionRange.EndPos.Row+1,0);
        }
